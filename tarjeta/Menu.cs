...
namespace tarjeta
{
    class Menu
    {
        ...
        public void AddMenuItems()
        {
            ...
            oMenuItem = SAPbouiCOM.Framework.Application.SBO_Application.Menus.Item("14592"); // moudles'
            ...
            try
            {
                ...
                oMenuItem = SAPbouiCOM.Framework.Application.SBO_Application.Menus.Item("tarjeta");
                oMenus = oMenuItem.SubMenus;

                // Create s sub menu
                oCreationPackage.Type = SAPbouiCOM.BoMenuType.mt_STRING;
                oCreationPackage.UniqueID = "tarjeta.Form1";
